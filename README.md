...
![The L-Game initial board](https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/L_Game_start_position.svg/330px-L_Game_start_position.svg.png)  
*The L-Game initial board. ([Source](https://en.wikipedia.org/wiki/L_game))*
